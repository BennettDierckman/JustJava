...
public class Reverse {
	...
	/**Reads a sequence of floating poin numbers
	 ...
	 * @param factor - the value wth which element is multiplied*/
	 ...
	 * @params values - an array of numbers
	 * @return an array that contains elements of values in reverse order*/
